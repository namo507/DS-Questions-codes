...
# 🏋️ The Gym Metaphor: Tracking Your Fitness Journey
...
```         
Week 1 to Week 2: 85 - 78 = 7 kg loss ✓
Week 1 to Week 3: 85 - 82 = 3 kg loss ✓
Week 1 to Week 4: 85 - 80 = 5 kg loss ✓
...
Week 2 to Week 3: 78 - 82 = -4 (gained weight, ignore)
...
```

This requires checking every pair → **O(n²) comparisons** — exhausting!
...
Day 4: Price=6, Min so far=1, Profit if sell=5,  Max profit=5  ⭐ NEW BEST!
...
# 🔍 Solution Breakdown: The Full Fitness Analysis
...
| 4 | 6 | Calculate profit | 1 | 5 | **5** | New best! 🏆 |
...
At each day, we either: 1. Find a new lowest price (potential better buy point) 2. Find a new maximum profit (potential best sell point)
...
**Result**: `0` — Like a bulk phase where you only gained weight, no "loss" to report!
...
**Total**: O(n) — One complete walk through your fitness journal
...
**Total**: O(1) — Just two numbers, like carrying a notepad with "lowest weight" and "best loss"
...
*"Track your personal bests, and the gains will follow. In trading and fitness, consistency and patience win."* 💪📈